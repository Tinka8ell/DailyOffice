...
Template generated content from json.

### Template

Generated by json structure of named templates:
...
See [example template](#example-template)

Specific types of component:

* [Heading](#heading) (size 2+)
* [Bible Quote](#bible-quote-version-reference)
* [Meditation](#meditation)
* [Extended Bible Reading](#extended-bible-reading-either-daily-or-yearly-based-on-date)
* [OMS Prayers](#oms-prayers)
* [World Watch List](#world-watch-list)
* [Paragraph](#paragraph) (now not used)
* [Lines](#lines) (now not used)
...
Was to be an array of [Lines](#lines) seperated by <br/> separators,
but now just implemented as subtemplates of div and span secions.

### Lines

No longer used. An array of parts that are either:
...
As a sample template manually created from a bible passage (see below):
```json
{
   "Psalm 3:1-4": {
      "div": true,
...
Taken from BibleGateway bible quote:
```html
